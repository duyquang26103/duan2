...
import ner.NerRecognizer;
import test.corenlp.parser.DependencyParser;
...
public class VnCoreNLP {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String fileIn =  projectPath + "\\dataFile\\input.txt";
        String fileOut = projectPath + "\\dataFile\\output.txt";
